...
rss_face_at_disp_cpp_export <- function(dispersion, cache, cbars_j, y, x, alpha, wt) {
    .Call(`_glmbayes_rss_face_at_disp_cpp_export`, dispersion, cache, cbars_j, y, x, alpha, wt)
}

UB2_cpp_export <- function(dispersion, cache, cbars_j, y, x, alpha, wt, rss_min_global) {
    .Call(`_glmbayes_UB2_cpp_export`, dispersion, cache, cbars_j, y, x, alpha, wt, rss_min_global)
}
