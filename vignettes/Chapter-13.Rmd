...
This complements **Chapter 12** (**bayesplot** graphics) with tabular summaries you can cite in applied reports.
...
- **Chapter 12** — **`bayesplot`** visualizations including **`pp_check()`** for **`glmb`**.  
