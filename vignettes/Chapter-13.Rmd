...
### 2.2 Eight Schools with dIndependent_Normal_Gamma Prior (commented out for vignette build)
...
```{r schools-indep-setup, eval = TRUE}
theta <- estimate
n_burn_schools <- 1000
n_sim_schools  <- 1000
