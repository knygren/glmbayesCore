...
| **Model-Specific Simulation Functions** | **rNormal_reg, rGamma_reg, rNormal_Gamma_reg, rindependent_norm_gamma_reg** | Chapter A2: Overview of Estimation Procedures |
| **pfamilies** |**dGamma, dNormal_Gamma, dIndependent_Normal_Gamma** | Chapter 11 — Estimating Models with Unknown Dispersion Parameters |
| **Methods**| **Various method functions for glmbayes** | Chapter A3 — Methods Available in glmbayes |
| **Envelope Related Functions** | Various Functions | Chapter A8 — Overview of Envelope Related Functions |
| **Parallel Simulation Related Functions** | Various Functions | Chapter A9: Parallel Sampling Implementation using RcppParallel |
