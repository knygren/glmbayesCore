...
- **Chapter 02 — Simple Bayesian models — conjugate inference for single parameters**  
  Work through Beta–Binomial, Gamma–Poisson, and Normal–Normal conjugate updating in closed form—useful intuition before multivariate regression with `lmb()` and `glmb()`.  
